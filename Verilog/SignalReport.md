...
| BEDO_n | CPU_PROC_32, CPU_PROC_CGA_33 | CPU_MMU_24, CPU_MMU_CSR_26 | Bus Error Data Out, active low, Buffered EDO_n, Buffered EDO (EDO = Enable DO signal (multiple IDB sources)), Bus Error Data Output, active low |
| BEMPID_n | CPU_PROC_32, CPU_PROC_CGA_33 | CPU_MMU_24, CPU_MMU_CSR_26 | Bus EMPID negated (Error Processor ID), Buffered EMPID_n, Buffered EMPID_n (EMPID = Enable Microcode Program ID), Bus Empty ID, active low |
| BERROR_n |  | BIF_5, BIF_BCTL_6 | Bus Error |
...
| BINACK_n |  | BIF_5, BIF_BCTL_6 | Bus Input Acknowledge |
...
| BLCS_n | CPU_CS_16 | CPU_MMU_24, CPU_MMU_CSR_26 | Buffered LCS_n (same as LCS_n), Bus LCS negated (Load Control Store), Buffered LCS_n |
...
| BMEM_n | PAL_44446B, MEM_43 | BIF_5, BIF_BCTL_6 | I3 - BMEM_n, Bus MEM enabled, Bus Memory, BUS MEMORY Enable |
...
| BREF_n |  | BIF_5, BIF_BCTL_6 | Bus Refresh |
| BREQ50_n |  | BIF_BCTL_SYNC_8 | BREQ50_n - Bus Request (50ns delayed) |
| BRK_n | PAL_44305D, PAL_44307C, PAL_44601B | CPU_15, CPU_PROC_32 | I8 - Break signal, active low, used to interrupt normal operation for debugging or error handling., I6 Break, I7 - BRK_n  - BREAK Cycle, CPU Break Signal, Break |
...
| CC2_n | PAL_44302B, PAL_44305D, PAL_44307C, BIF_5, BIF_BCTL_6, BIF_DPATH_9 | PAL_44601B | I2 - Cycle Control bit 2, I2 - Cycle control 2 (e+f+g+h+i+j+k), I3 Cycle Clock 2, Q4_n - Cycle Control 2 (negated), CPU Cycle Counter bit 2, Cycle Counter bit 2, Cpu Cycle bit 2 |
...
| CD_15_0_IN [15:0] | BIF_5, BIF_DPATH_9, BIF_DPATH_CDLBD_11, CPU_PROC_32 |  | CPU Data 16 bit IN, CPU Data IN, CPU Data Input (16 bits), CPU Data 15-0 |
| CD_15_0_OUT [15:0] |  | BIF_5, BIF_DPATH_9, BIF_DPATH_CDLBD_11 | CPU Data 16 bit OUT, CPU Data OUT, CPU Data Output (16 bits) |
...
| CUP | CPU_MMU_CSR_26 | PAL_44511A, CPU_PROC_32 | Q0_n - (not connected), Cache Updated (CUP) goes to IDB0 when ECSR_n is low , Cache Updated |
| CWR |  | CPU_PROC_32 | Cache Write |
| CWR_n |  | PAL_44511A | B0_n - CWR_n |
| CX_n |  | PAL_44601B | Q0_n - CX_n    - CX is always 1 in the fast version (CX_n = 0) |
| CYD | PAL_44402D | PAL_44307C | B1_n - CYD_n     Cycle Done ?, I4 |
...
| D8 [7:0] | SIP1M9 |  | DATA INPUT |
| D9 | SIP1M9 |  | DATA INPUT |
...
| DOUBLE |  | CPU_PROC_32, CPU_PROC_CGA_33 | Double, Double precision operation |
...
| EMPIDN | CGA_INTR | DECODE_DGA_COMM | Enable MPID - Set bits in the micro—P10 (Priority Interrupt Detect) register in the PIC. Command #12, EMP Interrupt Disable, active low |
| EORF_n |  | PAL_44307C | B2_n - EORF_n    End of Read Flag ? (Miscellaneous write pulse) |
...
| ESTOF_n | CPU_PROC_32 |  | Enable Store of Fault |
...
| FMISS | PAL_44402D | DECODE_DGA_COMM | I3, Cache miss during fetch |
...
| HIEN_n | PAL_44310D, PAL_45008B, MEM_ADDR_44, MEM_DATA_46, MEM_LBDIF_48 | PAL_44902A, MEM_RAMC_50 | I0, Q7_n - HIEN_n, I9 - EPEA_n  (NOT USED!), High address bits enable |
| HIERR |  | MEM_DATA_46 | High address bits error |
| HIGSN |  | CGA_INTR | High Speed signal, active low |
| HIK | CGA_INTR_CNTLR_CLR |  | HI K |
| HIT | PAL_44601B | CPU_MMU_24 | I6 - HIT    - Cache hit, Cache hit signal, indicates a successful cache lookup |
...
| I1P | IO_UART_42 |  | Current Loop Input 1 |
...
| IDB_15_0_IN [15:0] | CPU_CS_16, CPU_CS_TCV_20, CPU_PROC_32 |  | IDB 15 bit input, 16 bit IDB IN (when writing to CSBITS), Input IDB 15-0 |
| IDB_15_0_OUT [15:0] |  | BIF_5, BIF_DPATH_9, CPU_CS_TCV_20, CPU_PROC_32, IO_UART_42, MEM_43 | Internal Bus Data (IBD) 16 bit OUT, Internal Data Bus OUT, 16 bits IDB OUT (when reading a 16 bit word from CSBITS), Output IDB 15-0, Internal Data Bus 15:0 OUT, Bus Data 15:0 |
...
| IORQ_n | PAL_44302B, PAL_44445B, PAL_44801A, BIF_5, BIF_BCTL_6, BIF_DPATH_9, MEM_43 |  | B4_n - IO Request, I1 - IORQ_n - IO Request, I1 - IORQ_n (IO Request), Input Bus Request, Input I/O Request, Input/Output Request, Bus Input/Output Request |
...
| LA_20_10 [10:0] | CPU_MMU_PT_29 |  | 11 bit addressing into PT chips |
...
| LAPA_n |  | CPU_MMU_24 | Latch Page Address negated, controls latching of the page address |
...
| LCS_n | PAL_44305D, PAL_44407A, PAL_44408B, CPU_CS_16, CPU_MMU_CSR_26, CPU_PROC_32, CPU_PROC_CGA_33, IO_UART_42 | PAL_44403C | I4 - Load Control Store (negated), Q0_n, I6 - LCS_n, B0 - Load Control Store (negated), Load Control Store (Negated), Load Control Store, LCS_n (LCS = Load Control Store), Local Chip Select, active low |
...
| LEV0 |  | PAL_44511A, CPU_PROC_32 | B3_n - LEV0, Level 0 |
...
| LPERR_n | PAL_45001B, BIF_BCTL_6 | MEM_43, MEM_DATA_46 | I6 - LPERR_n, Local Parity Error |
| LPRERR_n | BIF_5 |  | Local Parity Error |
| LSHADOW | PAL_44402D, PAL_44404C, DECODE_DGA_COMM, CGA_DCD | CPU_15, CPU_PROC_32, CPU_PROC_CGA_33, CGA_MAC | I2, B1_n (new input for 44404D), Latch Shadow signal, Latch Shadow, Shadow Register Load, Load shadow, Shadow latch signal |
...
| MCL |  | DECODE_DGA_POW | Master Clear |
...
| O1P |  | IO_UART_42 | Current Loop Output 1 |
| O2P |  | IO_UART_42 | Current Loop Output 2 |
...
| OUTGRANT_n |  | BIF_5, BIF_BCTL_6 | Bus OUTGRANT, Output Grant |
...
| PPN_25_10_IN [15:0] | CPU_MMU_PT_29 |  | Physical Page Number (PPN) Bidirectional PPN (in) (bit 23-10 in the calculated physical address) |
| PPN_25_10_OUT [15:0] |  | CPU_MMU_PT_29 | Physical Page Number (PPN) Bidirectional PPN (out) (bit 23-10 in the calculated physical address) |
...
| PT_15_0_OUT [15:0] |  | CPU_MMU_24, CPU_MMU_PT_29 | Page Table data output, contains the page table entry data, Bidirectional PT (out) |
...
| Q8 [7:0] |  | SIP1M9 | DATA OUTPUT |
| Q9 |  | SIP1M9 | DATA OUTPUT |
| QA |  | M169C | Output A |
...
| RINRN |  | DECODE_DGA_IDBS | Read Installation Number (RINR) - 35 |
...
| RT_n | PAL_44302B, PAL_44402D, BIF_5, BIF_DPATH_9 | PAL_44408B, CPU_PROC_32 | B5_n - Return, I1, Q5_n, Return, RT_n - Return, Return signal |
...
| STP | CGA_MIC |  | Stop control signal |
...
| sys_rst_n | BIF_5, CPU_MMU_PT_29, CPU_PROC_CGA_33, IO_UART_42, SIP1M9 |  | System reset in FPGA |
| sysclk | ND120_TOP, BIF_5, CPU_MMU_PT_29, CPU_PROC_CGA_33, IO_UART_42, SIP1M9 |  | System Clock, System clock in FPGA |
| T [7:0] | AM29833A |  | T in |
...
| UCLK | CPU_PROC_32, CPU_PROC_CGA_33, DECODE_DGA_COMM | PAL_44307C | B3_n - UCLK      Update Clock ? (A universal clock signal for memory requests), User Clock, U clock |
...
| WCA_n | PAL_44305D, PAL_44511A, CPU_PROC_32 | PAL_44402D, CPU_MMU_24 | B4_n - WRITE INTO MICROINSTRUCTION CACHE (negated), B1_n (new input for 44404D), I6 - WCA_n, Write Cache Address negated, controls writing to the cache address register, Write Cache Address |
...
| WRITE | PAL_44303B, PAL_44445B, BIF_5, BIF_DPATH_9, MEM_43 | DECODE_DGA_COMM | I6, I0 - WRITE - Write to memory, Write, WRITE - Write, Write Cycle Active |
