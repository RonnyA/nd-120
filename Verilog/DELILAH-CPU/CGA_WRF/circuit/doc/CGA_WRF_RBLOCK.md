...
Source: `/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_WRF/circuit/CGA_WRF_RBLOCK.v`

> Generated by `Verilog/tests/module_doc.py` from the `//!`
> comments in the source. Do not edit by hand - edit the RTL comments and regenerate.

![CGA_WRF_RBLOCK symbol](CGA_WRF_RBLOCK.png)
...
| input | `1` | `ALUCLK` | To clock the operation |
