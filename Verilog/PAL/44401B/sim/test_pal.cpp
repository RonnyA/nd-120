...
struct TestCase {
    ...
    // Inputs
    bool OSC, CC2_n, CACT_n, CACT25_n, BDRY50_n, CGNT_n, CGNT50_n, TERM_n, IORQ_n, OE_n;
   
    
    //  Outputs
    bool  EADR_n, EIOD_n, Q2_n, Q1_n, Q0_n, DAP_n, APR_n;
...
int main(int argc, char **argv) 
{
    ...
    VPAL_44401B* top = new VPAL_44401B;
