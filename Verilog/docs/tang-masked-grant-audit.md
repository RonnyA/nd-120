...
- IREQ_15_0_N[10] pulses low. VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_IRSRC.v:141-147
...
- The request is caught by the sysclk catcher and registered at MCLK_EN.
  VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRQ_REG_RQBIT_V2.v:94-117
...
- MIREQ_n[10] goes active (low) only when LREQ[10]=1 AND PICMASK_N[10]=1.
  VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRQ_MREQ.v:83-89
...
- PICMASK_N is the q output of the per-bit mask flip-flop; PICMASK (readback
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRQ_MASK_MASKBIT.v:117-129
  ...
  /mnt/e/Dev/Repos/Ronny/ND110Compile/ND110CPU/AMD/Amd2914PIC.cs:501
  ("Mask Register. 1=Masked, 0=Enabled") and
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/docs/am2914-command-model.md ("Mask
...
- HIDET + HIVEC=2 from the high-chip priority encoder over MIREQ only (the
  ...
  encoder). VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_VECGEN_PTY.v:52-56.
- HIVGES = (HIVEC >= HISTAT), pure magnitude compare of the vector against the
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_VECGEN.v:137-144 (CMP).
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_VECGEN_STAT_SBIT.v:118-126)
...
- HIDIS_n = 1 (status-overflow / chip-disable FF). VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRGEL_HIRL.v:179-188
...
- int_req_q = 1 (the Am2914 "interrupt request enable" FF = ND PIC,ION/IOF).
  VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRGEL_HIRL.v:191-200
  (INT_REQ_ENABLE_FF: D=E, TE=D, TI=Q recirculate). Low-chip twin:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRGEL_LORL.v:150-158.
  Command decode driving it (VERIFIED,
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_MDCD.v):
  ...
  - Capture rule (SCAN_FF_EN, VERIFIED
    /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/Shared/ndlib/SCAN_FF_EN.v:42):
...
- HIRQ = HIDET AND HIVGES AND HIDIS_n AND int_req_q. VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRGEL_HIRL.v:131-138
  (GATES_3 = NAND3(HIVGES,HIDET,HIDIS_n)) and 157-163 (GATES_6 AND with
  int_req_q).
- IRQN = NOR(HIRQ, LIRQ). VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRGEL.v:118-124.
- INTRQN: MEMORY_2 registers d = (PAN asserted) OR (IRQ asserted) at MCLK_EN;
  INTRQN = qBar; async clear by CLIRQ. VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR.v:155-177
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DECODE-GateArray/DGA/circuit/DECODE_DGA_POW.v:232,242
...
- CLIRQN = ~(registered iclirq | master clear). VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_DCD/circuit/CGA_DCD.v:1163.
...
- Microcode reads the vector over the IDB under EPICVN / EPICSN. VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_IDBCTL/circuit/CGA_IDBCTL.v:110-115
...
- The claim that steers PICV: HVE = HIPASSALL AND (S active). VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRGEL_HIRL.v:165-171
  (GATES_7), where HIPASSALL = HIDET AND HIVGES AND HIDIS_n (GATES_3,
  lines 131-138) and S = RDVECT strobe (MDCD GATES_37,
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_MDCD.v:497-503).

  ***The RTL claim does NOT include int_req_q.*** The C# ground truth DOES:
  /mnt/e/Dev/Repos/Ronny/ND110Compile/ND110CPU/AMD/Amd2914PIC.cs (ReadVector):
...
- The mask register is loaded from FIDBO by the PIC command LDM (PIC,LMSK,
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR.v:124-131
...
- PIE (I7) as read by OPCOM/TRA is a microcode-held value, not a hardware read
  ...
  /mnt/e/Dev/Repos/Ronny/ND110Compile/ND110CPU/CpuInternals.cs and Cpu.cs finds
...
- Am2914 MASTER CLEAR (PIC,MCL, issued by the DELILAH microcode on every MCL)
  ...
  /mnt/e/Dev/Repos/Ronny/ND110Compile/ND110CPU/AMD/Amd2914PIC.cs:950-977
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/docs/am2914-command-model.md line for
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRQ_MASK_MASKBIT.v:74-114).

So between the microcode master clear and the FIRST PIC,LMSK (which only
happens when PIE is written / on the PICF2 path - see
/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/docs/RUN-level14-livelock-analysis.md),
...
- After master clear the status (fence) registers are 0: SBIT d-input is 0
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_VECGEN_STAT_SBIT.v:79-160
  and the strobe table in
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_VECGEN_STAT.v:176-196.
...
- IOF/ION interact with the grant ONLY through the int_req_q FFs:
  ...
  /mnt/e/Dev/Repos/Ronny/ND110Compile/ND110CPU/InterruptSubSystem.cs:458-467.
...
- NO register in the CGA_INTR tree has a reset tied to the board reset:
  ...
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR.v:13-44
...
- btn1 (S1) only re-runs the 256-cycle sys_rst_n pulse. VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/fpga/tang-nano-20k/src/ND120_TANG20K_TOP.v:102-128.
...
- Tang build mode: FPGA_FF_MODE is defined. VERIFIED:
  /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/fpga/tang-nano-20k/src/tang20k_defines.v:20.
...
Report:
/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/fpga/tang-nano-20k/build/nd120_tang20k_build/impl/pnr/nd120_tang20k_build.tr
...
Files: /mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_IRGEL_HIRL.v:191-200,
/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_CNTLR_MDCD.v:178,489-495.
...
(/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DECODE-GateArray/DGA/circuit/DECODE_DGA_POW.v,
...
(/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/sim/CGA_INTR_CNTLR_seq_tb.v)
...
(/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR_IRSRC.v:269-275)
...
/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/DELILAH-CPU/CGA_INTR/circuit/CGA_INTR.v:141-146:
...
/mnt/e/Dev/Repos/Ronny/nd-120/Verilog/fpga/tang-nano-20k/build/nd120_tang20k_build/.
