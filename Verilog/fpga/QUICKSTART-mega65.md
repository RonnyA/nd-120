...
TDV2200 codes, CAPS LOCK latches as the keycap does. **RUN/STOP is EXIT**
(the TDV2200's SLUTT key - how you leave a SINTRAN program); ALT+X is the
same key. The menu also sets the
