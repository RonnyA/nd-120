/*****************************************************************************
**  nd_storage_mega65_devices_tb.v                                          **
**                                                                          **
**  Full path: Verilog/fpga/mega65/sim/nd_storage_mega65_devices_tb.v       **
**                                                                          **
**  The whole MiSTer storage subsystem - two floppy adapters, two           **
**  Winchester adapters, the tape adapter, nd_storage_vdrives - driven at the**
**  controller seams (FDISK_*, FDBUF_*, WDISK_*, WDBUF_*, the tape byte port)  **
**  exactly as ND120_CORE drives them, against vdrives_model.v with five    **
...
module nd_storage_mega65_devices_tb;
