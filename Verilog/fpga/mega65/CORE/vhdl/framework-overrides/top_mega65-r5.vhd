...
begin
   ...
   qspidb_io             <= (others => 'Z');
   qspicsn_o             <= '1';
   -- ND-120 (02-SEP-2026, this file is CORE/vhdl/framework-overrides/, a copy
   -- of the framework's top with ONE change): the SDRAM pins are handed to
   -- MEGA65_Core instead of being parked, because the ND-120's main memory
   -- lives on this chip on R4/R5/R6 (build.tcl substitutes this file for
   -- the submodule's; diff against m2m/M2M/vhdl/top_mega65-rN.vhd to see
   -- exactly this). The framework itself never touches the SDRAM.
   -- (the sdram_* safe defaults of the framework's top are gone: the core drives the pins)
   ...
   CORE : entity work.MEGA65_Core
      ...
      port map (
         ...
         -- ND-120: the board's SDRAM, straight through to the core
