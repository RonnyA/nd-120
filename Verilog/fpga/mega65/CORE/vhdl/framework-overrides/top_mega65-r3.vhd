...
architecture synthesis of mega65_r3 is
   ...
   -- ND-120: the core's SDRAM data bus has nowhere to go on an R3
   signal sdram_dq_nc : std_logic_vector(15 downto 0);
...
begin
   ...
   CORE : entity work.MEGA65_Core
      ...
      port map (
         ...
         -- ND-120 (02-SEP-2026, CORE/vhdl/framework-overrides/ copy of the
         -- framework's top): an R3 has no SDRAM, so the core's SDRAM ports
         -- go nowhere. The R3 build uses the HyperRAM (MAIN_RAM_DDR2).
         sdram_clk_o             => open,
         sdram_cke_o             => open,
         sdram_ras_n_o           => open,
         sdram_cas_n_o           => open,
