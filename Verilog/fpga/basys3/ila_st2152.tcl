...
# CSA == o2152 (self-test done, 1130 dec): csa_2=0x1, csa[9:1]=0x35, csa_1=0
set_property TRIGGER_COMPARE_VALUE eq3'h1   $p2
set_property TRIGGER_COMPARE_VALUE eq9'h035 $p9
...
write_hw_ila_data -force -csv_file {E:/Dev/Repos/Ronny/nd-120/Verilog/fpga/basys3/logs/ila_st2152.csv} [current_hw_ila_data]
puts "ST2152_CAPTURED"
close_hw_target
