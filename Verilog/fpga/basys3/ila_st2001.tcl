...
# CSA == o2001 (exec start, 1025 dec): csa_2=0x1, csa[9:1]=0x000, csa_1=0x1
set_property TRIGGER_COMPARE_VALUE eq3'h1   $p2
set_property TRIGGER_COMPARE_VALUE eq9'h000 $p9
set_property TRIGGER_COMPARE_VALUE eq1'h1   $p1
...
write_hw_ila_data -force -csv_file {E:/Dev/Repos/Ronny/nd-120/Verilog/fpga/basys3/logs/ila_st2001.csv} [current_hw_ila_data]
puts "ST2001_CAPTURED"
close_hw_target
