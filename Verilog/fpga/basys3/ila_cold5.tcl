...
write_hw_ila_data -force -csv_file {E:/Dev/Repos/Ronny/nd-120/Verilog/fpga/basys3/logs/ila_cold5_check.csv} [current_hw_ila_data]
...
wait_on_hw_ila $ila
upload_hw_ila_data $ila
write_hw_ila_data -force -csv_file {E:/Dev/Repos/Ronny/nd-120/Verilog/fpga/basys3/logs/ila_cold5.csv} [current_hw_ila_data]
puts "COLD4_CAPTURED"
close_hw_target
