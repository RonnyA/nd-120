...
# o2001 (exec start after load): csa_2=0x1, csa=0x000, csa_1=0x1
...
write_hw_ila_data -force -csv_file {E:/Dev/Repos/Ronny/nd-120/Verilog/fpga/basys3/logs/ila_hold.csv} [current_hw_ila_data]
puts "HOLD_CAPTURED"
close_hw_target
