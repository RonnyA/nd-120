...
set_property TRIGGER_COMPARE_VALUE eq1'bR $lcs
set_property CONTROL.TRIGGER_POSITION 30 $ila
...
write_hw_ila_data -force -csv_file {E:/Dev/Repos/Ronny/nd-120/Verilog/fpga/basys3/logs/ila_lcs.csv} [current_hw_ila_data]
puts "LCS_CAPTURED"
close_hw_target
