...
module msg_printer18 #(
    parameter DELAY_FRAMES = 1406  // passed on to uart_tx
) (
    input clk,
    input rst_n,
  ...
  localparam S_BANNER = "\015\012ND120 TN20K SDRAM18 TEST 13.5MHZ 9600-8N1\015\012";
  localparam S_PROMPT = "PRESS S1 OR ANY KEY\015\012";
  localparam S_BLOCK  = "WRITE BLOCK (2M WORDS)\015\012";
  ...
  function [7:0] strchar(input [8*48-1:0] s, input integer len, input integer i);
  ...
  wire [23:0] a = {3'b0, addr_r};
  wire [19:0] d = {2'b0, data_r};
    ...
    case (msg_r)
      ...
      MSG_WRITE, MSG_READ_OK, MSG_READ_ERR: begin
        case (idx)
          ...
          6'd7:  ch = hexd(a[3:0]);
          6'd8:  ch = "=";
          6'd9:  ch = hexd(d[19:16]);
          6'd10: ch = hexd(d[15:12]);
          6'd11: ch = hexd(d[11:8]);
          6'd12: ch = hexd(d[7:4]);
          6'd13: ch = hexd(d[3:0]);
          default: begin
            case (msg_r)
